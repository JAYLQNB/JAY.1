...
function createMainWindow()
    ...
    OftenTab:Button({
        ...
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/thantzy/thanhub/refs/heads/main/thanv1", true))()
        end
    })
    ...
    OftenTab:Button({
        ...
        Desc = "中文",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/JsYb666/Item/refs/heads/main/%E5%88%B7%E5%80%BA%E5%88%B8", true))()
        end
    })
    ...
    InkgameTab:Button({
        ...
        Desc = "英文 好用",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/TexRBLX/Roblox-stuff/refs/heads/main/ink-game/script.lua", true))()
        end
    })
    ...
    InkgameTab:Button({
        ...
        Desc = "英文 好用",
        Callback = function()
            loadstring(game:HttpGet("https://rawscripts.net/raw/The-Strongest-Battlegrounds-NSExpression-v2-a3-TSBG-20252", true))()
        end
    })
    ...
    InkgameTab:Button({
        ...
        Desc = "英文",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/MortalR/wrwerew/refs/heads/main/ss"))()
        end
    })
    ...
    NightTab:Button({
        ...
        Desc = "中文",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/hdjsjjdgrhj/script-hub/refs/heads/main/99Nights", true))()
        end
    })
    ...
    ZombiTab:Button({
        ...
        Desc = "中文",
        Callback = function()
            loadstring(game:HttpGet("https://pastefy.app/A3Nqz4Np/raw", true))()
        end
    })
    ...
    ZombiTab:Button({
        ...
        Desc = "中文",
        Callback = function()
            loadstring(game:HttpGet("https://pastebin.com/raw/37tCRtum", true))()
        end
    })
    ...
    AbandTab:Button({
        ...
        Desc = "不知道",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/nikoladhima/Forsaken-Hub/refs/heads/main/ForsakenHub-Script.lua", true))()
        end
    })
    ...
    AbandTab:Button({
        ...
        Desc = "不知道",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Redexe19/RXGUIV1/refs/heads/main/RX%20Forsaken/RX_Forsakened", true))()
        end
    })
    ...
    NatureTab:Button({
        ...
        Desc = "英文 推荐搭配飞行使用",
        Callback = function()
            loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Super-ring-Parts-V6-28581", true))()
        end
    })
    ...
    StornTab:Button({
        ...
        Desc = "英文",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Cyborg883/TSB/refs/heads/main/CombatGui", true))()
        end
    })
    ...
    StornTab:Button({
        ...
        Desc = "英文 看不懂全开就行",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/10tempest01/tempest-hub/refs/heads/main/Launcher.lua", true))()
        end
    })
